...
@RunWith(Suite.class)
@Suite.SuiteClasses({ TestTenantServiceImpl.class, TestTenantRespository.class, TestUserDataRepository.class, TestDataSourceConfigRepository.class,
        TestSubjectAreaRespository.class })
