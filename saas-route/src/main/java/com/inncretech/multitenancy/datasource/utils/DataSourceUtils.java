...
public class DataSourceUtils {
    ...
    public static ComboPooledDataSource createDataSource(String driverClass, int initialPoolSize, int minPoolSize, int maxPoolSize,
            int acquireIncrement, String jdbcUrl, String user, String password) throws PropertyVetoException {
