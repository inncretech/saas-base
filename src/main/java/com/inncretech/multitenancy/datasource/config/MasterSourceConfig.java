...
@Configuration
@EnableJpaRepositories(basePackages = { "com.vxlpartners.appanalytix.master.db.repository" }, entityManagerFactoryRef = "masterEntityManagerFactory", transactionManagerRef = "masterTransactinManager")
public class MasterSourceConfig {
	...
	public ComboPooledDataSource masterDataSource() throws Exception {
		ComboPooledDataSource comboPooledDataSource = DataSourceUtils.createDataSource(driverClass, initialPoolSize,
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		localContainerEntityManagerFactoryBean.setPackagesToScan("com.vxlpartners.appanalytix.master.db.entity");
