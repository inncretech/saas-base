...
@Configuration
@Import(value = { MasterSourceConfig.class })
@EnableJpaRepositories(basePackages = { "com.vxlpartners.appanalytix.tenant.db.repository" }, entityManagerFactoryRef = "secondEntityManagerFactory", transactionManagerRef = "secondTransactinManager")
public class TenantDataSourceConfig {
		...
		for (DataSourceConfig config : dataSourceConfigs) {
			...
			ComboPooledDataSource comboPooledDataSource = DataSourceUtils.createDataSource(driverClass,
					initialPoolSize, minPoolSize, maxPoolSize, acquireIncrement, "jdbc:mysql://" + config.getDbUrl()
							+ "/" + config.getDbName() + "?zeroDateTimeBehavior=convertToNull&useSSL=false", config.getDbUserName(),
	...
	public LocalContainerEntityManagerFactoryBean secondEntityManagerFactory(
		...
		localContainerEntityManagerFactoryBean.setPackagesToScan("com.vxlpartners.appanalytix.tenant.db.entity");
